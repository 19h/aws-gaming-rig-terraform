...
function install-graphic-driver {
    ...
    if (!(Test-Path -Path "C:\Program Files\NVIDIA Corporation\NVSMI")) {
        ...
        # install licence
        Copy-S3Object -BucketName $Bucket -Key "GridSwCert-Archive/GridSwCertWindows_2021_10_2.cert" -LocalFile "C:\Users\Public\Documents\GridSwCert.txt" -Region us-east-1
